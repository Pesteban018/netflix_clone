...
final List<MovieOrSeries> myList = [
  MovieOrSeries(
      ...
      length: '51min',
      description:
          'The Simpsons are a normal American family living in Springfield, a fictional town in "middle America." Homer, the father, works as a safety inspector at the Springfield Nuclear Power Plant in Sector 7G, a position that contrasts with his careless and buffoonish personality.',
      seasons: 6,
      director: {},
      cast: []),
  MovieOrSeries(
